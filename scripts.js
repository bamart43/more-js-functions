...
function addTheValues(param1, param2){
    if(isNaN(param1) || isNaN(param2)){
        addToPage("One of the parameter is not a number, when added they equal " + param1 + " " + param2);
    }else{
...
addToPage("The current value of number is " + number);
addToPage("Number = " + number + " doubleMyNumber: " + doubleMyNumber(number));
addToPage("The current value of number is " + number);
